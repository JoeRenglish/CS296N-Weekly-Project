...
namespace StoryCreator.Controllers
{
    public class CharacterController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CharacterId,Name,Age,Gender,Birthday,Description,Date")] Character character)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CharacterId,Name,Age,Gender,Birthday,Description,Date")] Character character)
        {
